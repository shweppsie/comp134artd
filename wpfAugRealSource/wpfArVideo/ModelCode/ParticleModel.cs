...
namespace wpfArVideo
{
    class ParticleModel : ModelVisual3D, IModelCode
    {
        ...
        public void Init(wpfArVideo.Window1.MyModel mm)
        {
            ...
            mm.m3dg.Children.Add(pm.CreateParticleSystem(1000, Colors.Gray));
            mm.m3dg.Children.Add(pm.CreateParticleSystem(1000, Colors.Red));
            mm.m3dg.Children.Add(pm.CreateParticleSystem(1000, Colors.Silver));
            mm.m3dg.Children.Add(pm.CreateParticleSystem(1000, Colors.Orange));
            mm.m3dg.Children.Add(pm.CreateParticleSystem(1000, Colors.Yellow));
        ...
        private void OnFrame(object sender, EventArgs e)
        {
            ...
            double speed = 20.0; //10.0
            double sizeMult = 50.0; //1.0
