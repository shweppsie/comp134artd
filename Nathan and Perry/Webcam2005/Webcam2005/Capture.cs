...
namespace SnapShot
{
    ...
    internal class Capture : ISampleGrabberCB, IDisposable
    {
        ...
        public Capture(int iDeviceNum, int iWidth, int iHeight, short iBPP, Control hControl, Guid mediaSubType)
        {
            DsDevice [] capDevices;
            ...
            try
            {
                ...
                SetupGraph( capDevices[iDeviceNum], iWidth, iHeight, iBPP, hControl, mediaSubType);
        ...
        private void SetupGraph(DsDevice dev, int iWidth, int iHeight, short iBPP, Control hControl, Guid mediaSubType)
        {
            int hr;
            ...
            try
            {
                ...
                ConfigureSampleGrabber(sampGrabber, mediaSubType);
                ...
                //save the graph
                //wpfArVideo.GraphUtil.SaveGraphFile(m_FilterGraph, "capture.grf");
        ...
        private void ConfigureSampleGrabber(ISampleGrabber sampGrabber, Guid mediaSubType)
        {
            int hr;
            AMMediaType media = new AMMediaType();
            ...
            media.subType = mediaSubType; // MediaSubType.RGB32; //.RGB24;
        ...
        SampleDelegate sampleDelegate = null;
        ...
        int ISampleGrabberCB.BufferCB( double SampleTime, IntPtr pBuffer, int BufferLen )
        {
            ...
            //OnSampleEvent(pBuffer, BufferLen); //NOTE this was locking after a minute
            if (sampleDelegate == null)
            {
                sampleDelegate = new SampleDelegate(OnSampleEvent);
            }
            //NOTE this still locks up if you point it at something busy like a fan
            args[0] = BufferLen;
            //this.dispatcher.BeginInvoke(DispatcherPriority.Render, sampleDelegate, pBuffer, args);           
        ...
        public delegate void SampleDelegate(IntPtr pBuffer, int BufferLen);
        public event SampleDelegate SampleEvent;

        private void OnSampleEvent(IntPtr pBuffer, int BufferLen)
        {
            if (SampleEvent != null)
            {
                SampleEvent(pBuffer, BufferLen);
            }
        }
    }
}
